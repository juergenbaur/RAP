CLASS zcl_generate_travel_data_199 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_199 IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_199.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_199.

*   insert the new table entries
    INSERT ztravel_199 FROM TABLE @itab.
